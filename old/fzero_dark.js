...
function init() {
	...
	camera = new THREE.PerspectiveCamera(4, aspect, 0.1, 30);
	camera.position.y = 0;
	camera.position.x = 0;
	...
	var material = new THREE.MeshPhongMaterial( { color: 0x909090, specular: 0xFFFFFF, shininess: 50, flatShading: true } );
