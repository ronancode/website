...
document.getElementById('music-nav').onmouseover = function () {
    document.getElementById("music-nav").src="../img/music-nav-red.png";
}
document.getElementById('music-nav').onmouseout = function () {
    document.getElementById("music-nav").src="../img/music-nav.png";
}
document.getElementById('art-nav').onmouseover = function () {
    document.getElementById("art-nav").src="../img/art-nav-red.png";
}
document.getElementById('art-nav').onmouseout = function () {
    document.getElementById("art-nav").src="../img/art-nav.png";
}